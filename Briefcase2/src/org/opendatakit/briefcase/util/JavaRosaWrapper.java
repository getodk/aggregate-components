...
public class JavaRosaWrapper {
	...
	private static final String ENCRYPTED_FORM_DEFINITION = "<?xml version=\"1.0\"?>"
			...
			+ "<bind nodeset=\"/data/algorithm\" type=\"string\"/>"
			+ "<bind nodeset=\"/data/base64RsaEncryptedSymmetricKey\" type=\"string\"/>"
			...
			+ "<input ref=\"algorithm\"><label>algorithmString</label></input>"
			+ "<input ref=\"base64RsaPublicKey\"><label>formPublicKey</label></input>"
			+ "<input ref=\"base64RsaEncryptedSymmetricKey\"><label>encryptedSymmetricKey</label></input>"
